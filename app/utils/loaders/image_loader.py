...
sys.path.append('../../')
from utils.constants.constants import FILES_INPUT_DIR, FILES_OUTPUT_DIR, GEMINI_API_KEY, GEMINI_MODEL
from utils.prompts.Image_Description_prompt import IMAGE_DESCRIPTION_PROMPT
